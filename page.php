...
if ($result->num_rows > 0) {
    ...
    $slug_image = $row['image']; // Ảnh cho trang slug
} else {
...
<body style="background-image: url('uploads/<?php echo htmlspecialchars($slug_image); ?>'); background-size: cover; background-position: center; backdrop-filter: blur(5px);">
    <div id="header">
    ...
    <div id="container">
        ...
        <img id="artistImage" src="img/<?php echo htmlspecialchars($slug_image); ?>" alt="Artist Image">
